...
try:
    ...
    if daily_sleep:
        ...
        # Resting Physiology falling under sleep matrix
    ...
    # Restlessness Metric Calculation
    # Restlessness is tracked via Garmin's movement timeline or internal index scores
...
# Save only active resolved parameters
for k, v in m.items():
    if v != "--":
        db[key][k] = v
...
print(f"Database sync successful for {key}.")
